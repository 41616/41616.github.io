...
$\blacktriangleright$Step 2：由于$\usepackage{yhmath}\wodeparen{AF}=\wideparen{BC}=\wideparen{AE}$，所以$A'$是$\usepackage{fourier}\widearc{EF}$的中点，$A'D$过$I$。同理，$B'E$、$C'F$也过$I$，$I$是$A'D$、$B'E$、$C'F$的交点。
